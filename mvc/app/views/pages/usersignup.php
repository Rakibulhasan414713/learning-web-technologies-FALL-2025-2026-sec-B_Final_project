...
<div class="form">
  <form method="post" enctype="multipart/form-data" autocomplete="off" class="row" id="userSignupForm">
  <div id="ajaxErrorUserSignup" style="display:none;color:red;margin:10px 0;"></div>
      ...
      <div class="input-group ">
        <input type="email" placeholder="Email Address" name="email" style="width: 400px"; required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"/>
